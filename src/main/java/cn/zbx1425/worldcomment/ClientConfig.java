...
public class ClientConfig {
    ...
    public boolean isCommentVisible(Minecraft minecraft, CommentEntry comment) {
        ...
        ServerConfig.Visibility criteriaToUse = CommentEntry.isMarkerType(comment.messageType) ? serverIssuedConfig.markerVisibilityCriteria : serverIssuedConfig.commentVisibilityCriteria;
