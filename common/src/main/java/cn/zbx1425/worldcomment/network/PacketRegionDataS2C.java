...
public class PacketRegionDataS2C {
    ...
    public static final Identifier IDENTIFIER = Main.id("region_data");

    public static void send(ServerPlayer target, Identifier level, Map<ChunkPos, List<CommentEntry>> data) {
    ...
    public static class ClientLogics {
        ...
        public static void handle(FriendlyByteBuf buffer) {
            ...
            for (int i = 0; i < regionSize; i++) {
                ...
                regions.put(region.pack(), comments);
            }
